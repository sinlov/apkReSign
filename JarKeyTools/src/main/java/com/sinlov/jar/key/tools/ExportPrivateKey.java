...
public class ExportPrivateKey {
    ...
    public ExportPrivateKey(String keystoreFilePath, String keyStoreType, String password, String alias, String exportedFilePath) {
        this.keystoreFile = new File(keystoreFilePath);
        this.keyStoreType = keyStoreType;
        this.password = password.toCharArray();
        this.alias = alias;
        this.exportedFile = new File(exportedFilePath);
    }
